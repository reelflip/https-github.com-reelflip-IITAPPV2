...
export const DeploymentScreen: React.FC = () => {
    ...
    const downloadAllZip = async () => {
        ...
        try {
            ...
            link.href = url; link.download = "IITGEEPrep_Bundle_v12_23.zip";
            link.click();
                ...
                <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div>
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="px-2 py-1 rounded-md bg-slate-700 border border-slate-600 text-xs font-mono text-cyan-400">v12.23 (Latest)</span>
                        </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2 bg-white p-8 rounded-2xl border border-slate-200 shadow-sm space-y-6">
                        ...
                        <ol className="space-y-4 text-slate-600 text-sm list-decimal pl-5">
                            <li>Download the <strong>v12.23</strong> Bundle using the sidebar action.</li>
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <div className="bg-slate-900 rounded-2xl p-6 text-white shadow-xl relative overflow-hidden">
                            ...
                            <p className="text-slate-400 text-sm mb-6">Complete v12.23 backend kit including PHP APIs and SQL.</p>
                            <button onClick={downloadAllZip} disabled={isZipping} className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-xl flex items-center justify-center transition-all disabled:opacity-50">
                                {isZipping ? <RefreshCw className="animate-spin mr-2"/> : <Download className="mr-2"/>} Download v12.23 .zip
                            </button>
                        </div>
                    </div>
                </div>
