...
import { Download, Server, BookOpen, Package, FileText, Folder, ArrowRight, ShieldCheck, Database, Layout, Activity, PlugZap, CheckCircle2, XCircle, Lock, AlertTriangle } from 'lucide-react';
...
export const DeploymentScreen: React.FC = () => {
    ...
    const API_FILES = [
        'index.php', 'config.php', 'cors.php', 'test_db.php',
