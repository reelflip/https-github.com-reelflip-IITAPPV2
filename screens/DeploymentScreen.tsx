...
export const DeploymentScreen: React.FC = () => {
    ...
    const downloadAllZip = async () => {
        ...
        try {
            ...
            link.href = url; link.download = "IITGEEPrep_Full_v12_38.zip";
            link.click();
                ...
                <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div>
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="px-2 py-1 rounded-md bg-blue-600 text-xs font-mono text-white animate-pulse uppercase tracking-widest">v12.38 MASTER SYNC</span>
                        </div>
                ...
                <div className="space-y-8">
                    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
                        <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                            <div><h3 className="text-lg font-bold text-slate-800 flex items-center gap-2"><Database className="text-blue-500" size={20}/> Database Sync Tracker</h3><p className="text-sm text-slate-500">Checking v12.38 schema compliance across 26 tables.</p></div>
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
                        <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                            <div>
                                <h3 className="text-lg font-bold text-slate-800 flex items-center gap-2"><Activity className="text-orange-500" size={20}/> Module Integrity Scan (v12.38)</h3>
            ...
            {activeTab === 'guide' && (
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2 bg-white p-8 rounded-2xl border border-slate-200 shadow-sm space-y-6">
                        <h3 className="text-xl font-bold text-slate-800 flex items-center gap-2 text-blue-600"><CheckCircle2 className="animate-pulse" /> Master Synchronization Guide (v12.38)</h3>
                        <p className="text-slate-600 text-sm leading-relaxed">System v12.38 ensures 100% synchronization between frontend and backend. Your database currently reports 26 tables.</p>
                        <ol className="space-y-4 text-slate-600 text-sm list-decimal pl-5">
                            <li>Download the <strong>v12.38 Master Sync Bundle</strong>. It contains 38 PHP scripts.</li>
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <div className="bg-blue-900 rounded-2xl p-6 text-white shadow-xl relative overflow-hidden flex flex-col h-full">
                            ...
                            <button onClick={downloadAllZip} disabled={isZipping} className="w-full bg-white text-blue-900 font-black py-3 rounded-xl flex items-center justify-center transition-all disabled:opacity-50 shadow-lg active:scale-95 mt-4">
                                {isZipping ? <RefreshCw className="animate-spin mr-2"/> : <Download className="mr-2"/>} Download v12.38 (38 Files)
                            </button>
                        </div>
                    </div>
                </div>
