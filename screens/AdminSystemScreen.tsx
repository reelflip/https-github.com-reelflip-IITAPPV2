    ...
    <div className="space-y-8 animate-in fade-in pb-12">
      <div className="bg-slate-900 rounded-2xl p-8 text-white shadow-xl relative overflow-hidden">
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-6">
          <div><h2 className="text-3xl font-black flex items-center gap-3"><Activity className="text-blue-400" /> Admin System</h2><p className="text-slate-400 mt-2">v12.28 Hardened Maintenance Panel</p></div>
      ...
      {activeTab === 'health' && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 animate-in slide-in-from-bottom-4">
            <div className="bg-white rounded-2xl border border-slate-200 p-6">
                <h3 className="font-black uppercase tracking-wider text-xs mb-6 flex items-center gap-2"><Database className="text-blue-500"/> Database Schema (v12.28)</h3>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6">
                <h3 className="font-black uppercase tracking-wider text-xs mb-6 flex items-center gap-2"><FileCode className="text-orange-500"/> API File Map (38 Endpoints)</h3>
