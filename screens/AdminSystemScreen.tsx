    ...
    <div className="space-y-8 animate-in fade-in pb-12">
      ...
      {activeTab === 'health' && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 animate-in slide-in-from-bottom-4">
            <div className="bg-white rounded-2xl border border-slate-200 p-6">
                <h3 className="font-black uppercase tracking-wider text-xs mb-6 flex items-center gap-2"><Database className="text-blue-500"/> Database Schema (v12.23)</h3>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6">
                <h3 className="font-black uppercase tracking-wider text-xs mb-6 flex items-center gap-2"><FileCode className="text-orange-500"/> API File Map</h3>
